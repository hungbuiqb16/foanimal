...
<body>
  ...
  <section class="animal_section layout_padding">
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-6">
          <div class="img-box">
            <img src="static/images/animal-img.png" alt="" />
          </div>
        </div>
      </div>
    </div>
  ...
  <section class="forest_section layout_padding-bottom">
    <div class="container">
      <div class="row">
        <div class="col-md-6">
          <div class="img-box">
            <img src="static/images/forest-img.png" alt="" />
          </div>
        </div>
        <div class="col-md-6">
          <div class="detail-box">
  ...
  <section class="info_section  layout_padding2">
    <div class="footer_img fi1">
      <img src="static/images/footer-animal1.png" alt="">
    </div>
    <div class="footer_img fi2">
      <img src="static/images/footer-animal2.png" alt="">
    </div>
    <div class="container">
